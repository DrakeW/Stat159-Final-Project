...
To analyze potential factors that affect graduation rates, we generated another model. 
...
In terms of model comparison, PCR and PLSR fit better on the data sets again.
