...
div_table = xtable(format(div_df, digits=3), caption = "Regression Coefficients for All Diversity Models")
...
div_mse_table = xtable(format(div_mse_df, digits=4), caption = "Test MSE Values for All Diversity Models")
...
grad_table = xtable(format(grad_df, digits=3), caption = "Regression Coefficients for All Graduation Rate Models")
...
grad_mse_table = xtable(format(grad_mse_df, digits=4), caption = "Test MSE Values for All Graduation Rate Models")
